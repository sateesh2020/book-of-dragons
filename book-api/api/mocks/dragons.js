module.exports = [{
    ...
    "hiddenAbilities": {
        "description": "Toothless also possesses an echolocation sense not unlike radar or sonar. When flying through dark or cramped environments, Toothless issues a plasma blast in all directions. When the plasma bounces off the nearby terrain and returns to Toothless, it gives him an incredibly accurate reading of his surroundings."
    },
    "relationShips": [{
        "name": "Hiccup",
        "description": "Hiccup is Toothless’ human teammate, trainer and best friend.",
        "thumbnail": "dragons_toothless_hiccup.png"
    }]
}];
